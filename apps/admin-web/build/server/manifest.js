...
return {
	...
	_: {
		...
		nodes: [
			__memo(() => import('./chunks/0-0QP5EGlc.js')),
			__memo(() => import('./chunks/1-BkwR_-RY.js')),
			__memo(() => import('./chunks/2-ButVthKh.js')),
			__memo(() => import('./chunks/3-D4mC2k6v.js')),
			__memo(() => import('./chunks/4-BpRDq_yU.js')),
			__memo(() => import('./chunks/5-C2OCzRps.js')),
			__memo(() => import('./chunks/6-B4PVUyXM.js')),
			__memo(() => import('./chunks/7-bqgihE8B.js')),
			__memo(() => import('./chunks/8-Ces0Dm97.js'))
		],
		remotes: {
