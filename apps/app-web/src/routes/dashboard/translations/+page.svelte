...
<section class="py-12">
  <div class="max-w-6xl mx-auto px-6 space-y-10">
    ...
    <section class="rounded-xl border bg-white p-6 space-y-4">
      ...
      <MisTextarea variant="unstyled"
        id="translation-source"
        bind:value={text}
        className="w-full min-h-[180px] rounded-lg border p-4 text-sm leading-relaxed focus:border-emerald-500 focus:ring-emerald-500"
      ...
      <div class="flex items-center justify-between">
        ...
        <MisButton variant="unstyled" size="none"
          onclick={submit}
          disabled={loading}
          className="rounded-full bg-emerald-600 px-6 py-2 text-sm font-semibold text-white hover:bg-emerald-700 disabled:opacity-40"
        >
