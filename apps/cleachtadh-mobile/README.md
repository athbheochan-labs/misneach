# apps/cleachtadh-mobile

Capacitor container for Cleachtadh mobile delivery (Phase 2 bundled local assets).
...
Create `apps/cleachtadh-mobile/.env` from `.env.example` and set:
